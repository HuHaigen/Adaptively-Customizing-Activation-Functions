...
def loss_to_excel(step, cross_entropy, AdaptiveFun_name):
    path = os.path.join('./result_Densenet/cifar10_Densenet_loss_0.xlsx')
...
def evolution_to_excel(epoch, acc_test, pre_test, rec_test, f1_test, AdaptiveFun_name):
    path = os.path.join('./result_Densenet/cifar10_Densenet_evolution_0.xls')
    p = os.path.exists(path)
...
loss_to_excel(training_epochs, cross_entropy, 'LRelu')
evolution_to_excel(training_epochs, acc_test, pre_test, rec_test, f1_test, 'LRelu')
plt.plot(cross_entropy, '-k', label='LRelu')
